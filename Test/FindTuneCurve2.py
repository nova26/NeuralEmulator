...
from NeuralEmulator.Preprocessing.PreprocessingBlock import PreprocessingBlock, PreprocessingBlockPos
...
if __name__ == "__main__":
    ...
    preProcessBlock = PreprocessingBlockPos(vin)
    ...
    # Leak
    normalLeakSource = NormalLeakSource(noramalLeakSourceConfigurator, StaticSource(760.0 * (10 ** -3)))
    normalLeakSource2 = NormalLeakSource(noramalLeakSourceConfigurator, StaticSource(740.0 * (10 ** -3)))
    normalLeakSource3 = NormalLeakSource(noramalLeakSourceConfigurator, StaticSource(720 * (10 ** -3)))
    normalLeakSource4 = NormalLeakSource(noramalLeakSourceConfigurator, StaticSource(700 * (10 ** -3)))

    normalLeakSource5 = NormalLeakSource(noramalLeakSourceConfigurator, StaticSource((725) * (10 ** -3)))
    normalLeakSource6 = NormalLeakSource(noramalLeakSourceConfigurator, StaticSource((700) * (10 ** -3)))
    normalLeakSource7 = NormalLeakSource(noramalLeakSourceConfigurator, StaticSource((675) * (10 ** -3)))
    normalLeakSource8 = NormalLeakSource(noramalLeakSourceConfigurator, StaticSource((650) * (10 ** -3)))

    # Neuron
    ozNeuron1 = OZNeuron(ozNeuronConfigurator, positivePulseSynapse, normalLeakSource)
    ...
    L3 = [ozNeuron3, ozNeuron4, ozNeuron7,ozNeuron8]
