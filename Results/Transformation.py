...
for v in vals:
    ...
    for x in range(2, 10, 2):
        ...
        OUTOUT_FOLDER = "C:\\Users\\Avi\\Desktop\\IntelliSpikesLab\\Emulator\\results\\Emulator\\Transformation\\{}OZ".format(NUMBER_OF_NEURONS)
        ...
        errorBlocks = ErrorBlock(adder, squaredSin, NUMBER_OF_NEURONS)
